...
section.page-contact
	...
	Loading(:active="req.status.value==='pending'")
		...
		Message(v-if="req.status.value==='success'" severity="success" :closable="false" icon="pi pi-check")
		...
		form(v-else @submit="onSubmit")
			...
			.foot
				Message(v-if="req.error.value" severity="warn" :closable="false" icon="pi pi-exclamation-circle") {{ req.error.value }}
				.bts
